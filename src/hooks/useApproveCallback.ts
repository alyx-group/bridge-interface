...
import { BRIDGE_ADDRESSES, SWAP_ROUTER_ADDRESSES, V2_ROUTER_ADDRESS } from '../constants/addresses'
...
// wraps useApproveCallback in the context of a bridge swap
export function useApproveCallbackFromBridgeSwap() {
  const { chainId } = useActiveWeb3React()
  const bridgeAddress = chainId ? BRIDGE_ADDRESSES[chainId] : undefined
