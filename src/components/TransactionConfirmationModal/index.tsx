...
import { CHAIN_INFO, L2_CHAIN_IDS, SupportedL2ChainId, ALL_SUPPORTED_CHAIN_SHORT_NAMES, ALL_SUPPORTED_CHAIN_SHORT_NAMES_MAP_TO_CHAINID } from 'constants/chains'
...
import { useGetTargetChainWithdrawTxHashQuery } from 'state/bridge/slice'
...
function TransactionSubmittedContent({
  ...
  console.log('withTxHash',withTxHash)
          ...
          {chainId && hash && (
            <ExternalLink href={getExplorerLink(chainId, hash, ExplorerDataType.TRANSACTION)}>
              <Text fontWeight={500} fontSize={14} color={theme.primary1}>
                <Trans>View Tx on Source Chain Explorer</Trans>
              </Text>
            </ExternalLink>
          )}
          {targetChainId && withTxHash? (
            <ExternalLink href={getExplorerLink(targetChainId, withTxHash, ExplorerDataType.TRANSACTION)}>
              <Text fontWeight={500} fontSize={14} color={theme.primary1}>
                <Trans>View Tx on Target Chain Explorer</Trans>
              </Text>
            </ExternalLink>
          ):<Loader stroke="white" />}
