...
export const ButtonLight = styled(BaseButton)`
  ...
  top: 100px;
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme, disabled }) => !disabled && darken(0.03, theme.advancedBG)};
    background-color: ${({ theme, disabled }) => !disabled && darken(0.03, theme.advancedBG)};
  }
  &:hover {
    cursor: auto;
    background-color: ${({ theme, disabled }) => !disabled && darken(0.03, theme.advancedBG)};
...
export function ButtonConfirmed({
  ...
  if (confirmed) {
    ...
    return <ButtonPrimary id={"ButtonPrimary"} {...rest} altDisabledStyle={altDisabledStyle} />
  }
}
