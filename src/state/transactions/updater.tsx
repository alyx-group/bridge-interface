...
import {DEPOSIT_NATIVE_TOPIC, DEPOSIT_TOKEN_TOPIC } from '../../constants/misc'
            ...
            if (receipt) {
              dispatch(
                finalizeTransaction({
                  ...
                  deposits: receipt.logs.filter((event)=> event.topics[0]===DEPOSIT_NATIVE_TOPIC||event.topics[0]===DEPOSIT_TOKEN_TOPIC),
                })
              )
