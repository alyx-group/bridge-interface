...
interface GovernorBravoInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_initiate', values: [BigNumberish]): string
...
export class GovernorBravo extends BaseContract {
  ...
  callStatic: {
    ...
    _initiate(proposalCount: BigNumberish, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    ...
    ProposalCanceled(id?: null): TypedEventFilter<[BigNumber], { id: BigNumber }>
    ...
    ProposalExecuted(id?: null): TypedEventFilter<[BigNumber], { id: BigNumber }>

    ProposalQueued(id?: null, eta?: null): TypedEventFilter<[BigNumber, BigNumber], { id: BigNumber; eta: BigNumber }>

    ProposalThresholdSet(
      oldProposalThreshold?: null,
      newProposalThreshold?: null
    ): TypedEventFilter<[BigNumber, BigNumber], { oldProposalThreshold: BigNumber; newProposalThreshold: BigNumber }>
    ...
    VotingDelaySet(
      oldVotingDelay?: null,
      newVotingDelay?: null
    ): TypedEventFilter<[BigNumber, BigNumber], { oldVotingDelay: BigNumber; newVotingDelay: BigNumber }>

    VotingPeriodSet(
      oldVotingPeriod?: null,
      newVotingPeriod?: null
    ): TypedEventFilter<[BigNumber, BigNumber], { oldVotingPeriod: BigNumber; newVotingPeriod: BigNumber }>
  }
  ...
  estimateGas: {
    ...
    cancel(proposalId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    queue(proposalId: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
